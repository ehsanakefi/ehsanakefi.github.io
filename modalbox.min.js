  ...
  console.log(title,"item",(items)) 
   tex=""   
      items.split(",").map((item)=>{
        console.log(item,item.split("@")[0]=="image",item.split("@")[0])
